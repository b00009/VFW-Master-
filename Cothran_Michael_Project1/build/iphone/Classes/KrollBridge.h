...
@interface Cothran_Michael_Project1Object : KrollCoverageObject {
#else
@interface Cothran_Michael_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Cothran_Michael_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Cothran_Michael_Project1Object *_cothran_michael_project1;
    KrollObject* console;
	BOOL shutdown;
