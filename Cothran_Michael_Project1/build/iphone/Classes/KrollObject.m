...
//@interface Cothran_Michael_Project1Object : NSObject
//@end

@interface Cothran_Michael_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Cothran_Michael_Project1Object class]])
		{
			for (NSString *key in [[(Cothran_Michael_Project1Object*)o modules] allKeys])
			{
