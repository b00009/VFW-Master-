...
/**
 The base class for all Cothran_Michael_Project1 modules
 */
...
/**
 Cothran_Michael_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Cothran_Michael_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Cothran_Michael_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Cothran_Michael_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Cothran_Michael_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
