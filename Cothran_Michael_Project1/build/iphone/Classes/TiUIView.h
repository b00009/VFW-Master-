...
/**
 Base class for all Cothran_Michael_Project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Cothran_Michael_Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
