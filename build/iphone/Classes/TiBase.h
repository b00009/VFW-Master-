...
// in simulator we redefine to format for Cothran_Michael_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.cothran_michael_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cothran_michael_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICothran_Michael_Project1NativeItemNone = -1, 
	UICothran_Michael_Project1NativeItemSpinner = -2,
	UICothran_Michael_Project1NativeItemProgressBar = -3,
	
	UICothran_Michael_Project1NativeItemSlider = -4,
	UICothran_Michael_Project1NativeItemSwitch = -5,
	UICothran_Michael_Project1NativeItemMultiButton = -6,
	UICothran_Michael_Project1NativeItemSegmented = -7,
	
	UICothran_Michael_Project1NativeItemTextView = -8,
	UICothran_Michael_Project1NativeItemTextField = -9,
	UICothran_Michael_Project1NativeItemSearchBar = -10,
	
	UICothran_Michael_Project1NativeItemPicker = -11,
	UICothran_Michael_Project1NativeItemDatePicker = -12,
	
	UICothran_Michael_Project1NativeItemInfoLight = -13,
	UICothran_Michael_Project1NativeItemInfoDark = -14,
	
	UICothran_Michael_Project1NativeItemDisclosure = -15,
	
	UICothran_Michael_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Cothran_Michael_Project1 instances of
