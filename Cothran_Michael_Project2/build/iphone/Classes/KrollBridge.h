...
@interface Cothran_Michael_Project2Object : KrollCoverageObject {
#else
@interface Cothran_Michael_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Cothran_Michael_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Cothran_Michael_Project2Object *_cothran_michael_project2;
    KrollObject* console;
	BOOL shutdown;
