...
//@interface Cothran_Michael_Project2Object : NSObject
//@end

@interface Cothran_Michael_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Cothran_Michael_Project2Object class]])
		{
			for (NSString *key in [[(Cothran_Michael_Project2Object*)o modules] allKeys])
			{
