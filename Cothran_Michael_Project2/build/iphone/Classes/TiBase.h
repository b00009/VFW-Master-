...
// in simulator we redefine to format for Cothran_Michael_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.cothran_michael_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cothran_michael_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICothran_Michael_Project2NativeItemNone = -1, 
	UICothran_Michael_Project2NativeItemSpinner = -2,
	UICothran_Michael_Project2NativeItemProgressBar = -3,
	
	UICothran_Michael_Project2NativeItemSlider = -4,
	UICothran_Michael_Project2NativeItemSwitch = -5,
	UICothran_Michael_Project2NativeItemMultiButton = -6,
	UICothran_Michael_Project2NativeItemSegmented = -7,
	
	UICothran_Michael_Project2NativeItemTextView = -8,
	UICothran_Michael_Project2NativeItemTextField = -9,
	UICothran_Michael_Project2NativeItemSearchBar = -10,
	
	UICothran_Michael_Project2NativeItemPicker = -11,
	UICothran_Michael_Project2NativeItemDatePicker = -12,
	
	UICothran_Michael_Project2NativeItemInfoLight = -13,
	UICothran_Michael_Project2NativeItemInfoDark = -14,
	
	UICothran_Michael_Project2NativeItemDisclosure = -15,
	
	UICothran_Michael_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Cothran_Michael_Project2 instances of
