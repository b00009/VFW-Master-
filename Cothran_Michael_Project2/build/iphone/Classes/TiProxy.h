...
//Rare exceptions to indicate a bug in the _cothran_michael_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Cothran_Michael_Project2 proxies.
 */
